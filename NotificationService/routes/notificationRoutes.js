...
router.post('/order-confirmation', (req, res) => {
  ...
  const message = `Dear customer, <br><br> Your order <strong>${orderId}</strong> has been successfully placed. Thank you for shopping with us!<br><br><a href="http://quicktradehub.com/orders/${orderId}" class="btn">View Order</a>`;
...
router.post('/shipment-update', (req, res) => {
  ...
  const message = `Dear customer, <br><br> Your order <strong>${orderId}</strong> has been shipped. Status: ${status}.<br><br>Track your shipment <a href="http://quicktradehub.com/track/${orderId}" class="btn">Track Order</a>`;
...
router.post('/payment-receipt', (req, res) => {
  ...
  const message = `Dear customer, <br><br> Payment of <strong>$${amount}</strong> for order <strong>${orderId}</strong> has been successfully received. Thank you for your payment.<br><br>For more details, visit your <a href="http://quicktradehub.com/orders/${orderId}" class="btn">Order History</a>`;
...
router.post('/promotions', (req, res) => {
  ...
  const message = `Hello, <br><br> Enjoy our special promotion: <strong>${promotionDetails}</strong><br><br>Claim your offer now!<br><br><a href="http://quicktradehub.com/promotions" class="btn">Grab Offer</a>`;
...
router.post('/support-ticket', (req, res) => {
  ...
  const message = `Dear customer, <br><br> Your support ticket <strong>${ticketId}</strong> has been created. Issue: ${issueDescription}.<br><br>Our support team will get back to you soon. <a href="http://quicktradehub.com/support/${ticketId}" class="btn">View Ticket</a>`;
...
router.post('/newsletter', (req, res) => {
  ...
  const message = `Hello, <br><br> Here's the latest newsletter from QuickTradeHub: <br><br>${newsletterContent}<br><br><a href="http://quicktradehub.com/newsletter" class="btn">Read More</a>`;
...
router.post('/special-offer', (req, res) => {
  ...
  const message = `Hello, <br><br> We have an exclusive offer just for you: <strong>${offerDetails}</strong><br><br>Don't miss out! <a href="http://quicktradehub.com/special-offers" class="btn">Claim Offer</a>`;
