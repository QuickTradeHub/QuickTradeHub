    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 to-purple-700 p-8 text-white flex items-center justify-center">
      <div className="max-w-4xl w-full bg-white text-gray-800 rounded-3xl shadow-2xl overflow-hidden animate-fade-in">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-10 text-center relative">
          ...
          />
          <h1 className="text-4xl font-extrabold mt-4 text-white drop-shadow-lg">Welcome, {user.firstName} {user.lastName}</h1>
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gray-50 p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
            <h2 className="text-2xl font-semibold mb-4 text-indigo-600">Account Details</h2>
          ...
          <div className="bg-gray-50 p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
            <h2 className="text-2xl font-semibold mb-4 text-indigo-600">Roles</h2>
        ...
        {/* Address Section */}
        <div className="p-8">
          <h2 className="text-3xl font-semibold mb-6 text-indigo-600">Saved Addresses</h2>
          {user.addresses.length > 0 ? (
            ...
            <p className="text-gray-600 text-lg">No addresses found. Please add a shipping address.</p>
          )}
        </div>
