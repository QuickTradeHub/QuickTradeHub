  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-500 via-indigo-600 to-blue-500 flex justify-center items-center py-6 px-4">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-xl space-y-6 sm:p-10 sm:max-w-2xl">
        <h2 className="text-3xl font-semibold text-center text-gray-800 mb-6">List Your Product</h2>

        <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data" className="space-y-6">
          {/* Product Title */}
          <div className="mb-4">
            <label htmlFor="title" className="text-lg font-medium text-gray-700">Product Title</label>
            <input
              id="title"
              name="title"
              type="text"
          ...
          {/* Condition */}
          <div className="mb-4">
            <label htmlFor="condition" className="text-lg font-medium text-gray-700">Condition</label>
            <select
              id="condition"
              name="condition"
              className="mt-2 w-full p-4 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ...
            {errors.condition && <p className="text-red-500 text-sm mt-2">{errors.condition.message}</p>}
          </div>

          {/* Shipping */}
          <div className="mb-4">
            <label htmlFor="shipping" className="text-lg font-medium text-gray-700">Shipping Options</label>
            <select
              id="shipping"
              name="shipping"
              className="mt-2 w-full p-4 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ...
            {errors.shipping && <p className="text-red-500 text-sm mt-2">{errors.shipping.message}</p>}
          </div>

          {/* Image Upload */}
          <div className="mb-4">
            <label htmlFor="images" className="text-lg font-medium text-gray-700">Product Images</label>
          ...
          {/* Thumbnail */}
          <div className="mb-4">
            <label htmlFor="thumbnail" className="text-lg font-medium text-gray-700">Product Thumbnail</label>
            <div className="relative mt-2">
              <input
                id="thumbnail"
                name="thumbnail"
